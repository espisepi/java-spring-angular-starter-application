...
export class TagService {
    ...
    create(request: TagRequest): Observable<Tag> { return this.connector.create(request); }
    update(id: number, request: TagRequest): Observable<Tag> { return this.connector.update(id, request); }
