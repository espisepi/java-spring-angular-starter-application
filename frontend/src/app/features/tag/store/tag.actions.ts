...
export const create = createAction('[Tag] Create', props<{ requestId: string; request: TagRequest }>());
...
export const update = createAction('[Tag] Update', props<{ requestId: string; id: number; request: TagRequest }>());
